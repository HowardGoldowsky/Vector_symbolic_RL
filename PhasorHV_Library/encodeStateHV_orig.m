%function H = encodeStateHV_orig(prevState, state, H, P1, P2, P3, P4, maxVal, minVal)
function [H,P] = encodeStateHV_orig(state, H, P1, P2, P3, P4, maxVal, minVal, J)
